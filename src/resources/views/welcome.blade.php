    ...
    <section id="faq" class="faq">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("{{ asset('img/faq.jpg') }}");'>&nbsp;</div>
        </div>
          ...
          <div class="row g-0 portfolio-container">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              ...
              <div class="portfolio-info">
                <h4>App 1</h4>
                <a href="{{ asset('img/portfolio/app-1.jpg') }}" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              ...
              <div class="portfolio-info">
                <h4>Product 1</h4>
                <a href="{{ asset('img/portfolio/product-1.jpg') }}" title="Product 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              ...
              <div class="portfolio-info">
                <h4>Branding 1</h4>
                <a href="{{ asset('img/portfolio/branding-1.jpg') }}" title="Branding 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              ...
              <div class="portfolio-info">
                <h4>Books 1</h4>
                <a href="{{ asset('img/portfolio/books-1.jpg') }}" title="Branding 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              ...
              <div class="portfolio-info">
                <h4>App 2</h4>
                <a href="{{ asset('img/portfolio/app-2.jpg') }}" title="App 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              ...
              <div class="portfolio-info">
                <h4>Product 2</h4>
                <a href="{{ asset('img/portfolio/product-2.jpg') }}" title="Product 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              ...
              <div class="portfolio-info">
                <h4>Branding 2</h4>
                <a href="{{ asset('img/portfolio/branding-2.jpg') }}" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              ...
              <div class="portfolio-info">
                <h4>Books 2</h4>
                <a href="{{ asset('img/portfolio/books-2.jpg') }}" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              ...
              <div class="portfolio-info">
                <h4>App 3</h4>
                <a href="{{ asset('img/portfolio/app-3.jpg') }}" title="App 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              ...
              <div class="portfolio-info">
                <h4>Product 3</h4>
                <a href="{{ asset('img/portfolio/product-3.jpg') }}" title="Product 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              ...
              <div class="portfolio-info">
                <h4>Branding 3</h4>
                <a href="{{ asset('img/portfolio/branding-3.jpg') }}" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              ...
              <div class="portfolio-info">
                <h4>Books 3</h4>
                <a href="{{ asset('img/portfolio/books-3.jpg') }}" title="Branding 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
